...
String TO_LONG_DRONE_SN = "Serial numberr lenght must be max" + MAX_DRONE_SN_LENGHT;
String MISSING_DRONE_SN = "Missing dron serial number";
String MISSING_MODEL_DRONE = "Missing model of drone";
